			...
			<div className={styles.guide_content}>
						...
						<Tab>
							<div>
								{/* <img
									...
									src="/img/panda_intro.png"
									alt=""
								/> */}
								<p>
									<wb>СИЛЬНЫЕ СТОРОНЫ:</wb>
								</p>
								<p>
				...
				<div className={styles.l_space}>
					<Tab>
						...
						<p>
							<img className={styles.img_minus} src="/img/minus.png" alt="" />
							Требование к большому количеству привязки горячих клавиш (биндов),
							которые необходимо отслеживать;
						</p>
						<p>
							<img className={styles.img_minus} src="/img/minus.png" alt="" />
							Может потребоваться установить дополнительные аддоны или WeakAura
							для отслеживания эффекта Пошатывание;
						</p>
					</Tab>
				</div>
			</div>
